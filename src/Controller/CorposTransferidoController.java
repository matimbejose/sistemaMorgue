...
public class CorposTransferidoController 
{
    ...
    public void recebeCTransF() {
        int codCorpo = Validacoes.ValidarInt("Informe o codigo do corpo : ", 9999, 1000);
        char  tipoCorpo = Validacoes.validarChar("Informe o tipo de corpo  [c-conhecido/d-desconhecido] :", 1, 1);
        int codMorgue = Validacoes.ValidarInt("Informe o codigo da morgue : ", 9999, 1000);
